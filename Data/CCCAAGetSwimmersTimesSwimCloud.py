...
for div in divisionsList:
    ...
    for gender in genderList:
        ...
        for event in relay_num_list:
            ...
            i = 0
            while i in range(
                    len(td_text) - 1):  # td_text is a multiple of 6 so guaranteed to not go out of index if we access the first element of the 6
                place = td_text[i]
                name = td_text[i + 1]
                team = td_text[i + 2]
                meet = td_text[i + 3]
